...
class Events extends Component {
  ...
  render() {
    ...
    if (!user || !eventCalendarId) {
      eventInfo = (
        <div className="alert alert-message" name="Events">
          To see your upcoming events, make sure you are signed in and have added a
          Calendar ID in the{' '}
          <span
            role="link"
      ...
      eventInfo = (
        <div className="alert alert-error">
          <strong>Error fetching events!</strong> Please try logging out and back in.
        </div>
      );
      ...
      eventInfo = (
        ...
        >
          ...
          <div className="next-meeting">
            <span className="meeting-prefix">{`Next meeting is ${nextEventText}: `}</span>
